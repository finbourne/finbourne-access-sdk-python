...
from finbourne_access.api_client import ApiClient as AsyncApiClient
...
import finbourne_access.extensions.retry as retry
from finbourne_access.extensions.socket_keep_alive import keep_alive_socket_options
from finbourne_access.extensions.tcp_keep_alive_connector import TcpKeepAliveConnector
import os
...
def build_client(
    ...
    try:
        ...
        # Set the proxy for finbourne_access if needed
